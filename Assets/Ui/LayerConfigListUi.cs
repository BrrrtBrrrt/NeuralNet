...
namespace Assets.Ui
{
    public class LayerConfigListUi : VisualElement
    {
        public new class UxmlFactory : UxmlFactory<LayerConfigListUi, UxmlTraits> { }
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                LayerConfigListUi layerConfigListUi = (LayerConfigListUi)ve;
                LayerConfig layerConfig = layerConfigListUi.layerConfig;
                ...
                layerConfigListUi.layerConfig = layerConfig;
            }
        }
        ...
        public LayerConfigListUi()
        {
            // Load the UXML file
            VisualTreeAsset visualTree = Resources.Load<VisualTreeAsset>("Ui/LayerConfigListUi");
